...
import com.neko233.toolchain.commons.core.exception.UtilException;
import com.neko233.toolchain.commons.core.random.WeightObject;
import com.neko233.toolchain.commons.core.random.WeightRandom;
...
public class RandomUtils233 {
     ...
     * @return 随机数
     */
    public static BigDecimal randomBigDecimal(BigDecimal min,
                                              BigDecimal max) {
     ...
     * @return 随机元素
     */
    public static <T> List<T> randomObject(List<T> list,
                                           int count) {
     ...
     * @return 随机列表
     */
    public static <T> List<T> randomObjectList(List<T> source,
                                               int needCount) {
     ...
     */
    public static <T> Set<T> randomObjectSet(Collection<T> collection,
                                             int count) {
     ...
     * @return 随机字符串
     */
    public static String randomStringWithoutStr(int length,
                                                String elemData) {
     ...
     */
    public static LocalDateTime randomDay(int min,
                                          int max) {
