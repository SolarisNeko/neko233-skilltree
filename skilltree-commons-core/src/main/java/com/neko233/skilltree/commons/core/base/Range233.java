 ...
 * @since 3.0
 */
public final class Range233<T> implements Serializable {
     ...
     */
    public static <T extends Comparable<T>> Range233<T> between(final T fromInclusive,
                                                                final T toInclusive) {
     ...
     */
    public static <T> Range233<T> between(final T fromInclusive,
                                          final T toInclusive,
                                          final Comparator<T> comparator) {
        return new Range233<>(fromInclusive, toInclusive, comparator);
    }
     ...
     */
    public static <T extends Comparable<T>> Range233<T> is(final T element) {
     ...
     * @throws ClassCastException       if using natural ordering and the elements are not {@code Comparable}
     */
    public static <T> Range233<T> is(final T element,
                                     final Comparator<T> comparator) {
    ...
    private Range233(final T element1,
                     final T element2,
     ...
     *
     * @param otherRange233 the range to check, null returns false
     * @return true if this range contains the specified range
     * @throws RuntimeException if ranges cannot be compared
     */
    public boolean containsRange(final Range233<T> otherRange233) {
        if (otherRange233 == null) {
            return false;
        }
        return contains(otherRange233.minimum)
                && contains(otherRange233.maximum);
    }
    ...
    public boolean equals(final Object obj) {
        if (obj == this) {
            ...
            final Range233<T> range233 = (Range233<T>) obj;
            return minimum.equals(range233.minimum) &&
                    maximum.equals(range233.maximum);
        }
    }
     ...
     * @since 3.0.1
     */
    public Range233<T> intersectionWith(final Range233<T> other) {
     ...
     * @throws RuntimeException if ranges cannot be compared
     */
    public boolean isAfterRange(final Range233<T> otherRange233) {
        if (otherRange233 == null) {
            return false;
        }
        return isAfter(otherRange233.maximum);
    }
     ...
     * @throws RuntimeException if ranges cannot be compared
     */
    public boolean isBeforeRange(final Range233<T> otherRange233) {
        if (otherRange233 == null) {
            return false;
        }
        return isBefore(otherRange233.minimum);
    }
     ...
     * <p>This method may fail if the ranges have two different comparators or element types.</p>
     *
     * @param otherRange233 the range to test, null returns false
     * @return true if the specified range overlaps with this
     * range; otherwise, {@code false}
     * @throws RuntimeException if ranges cannot be compared
     */
    public boolean isOverlappedBy(final Range233<T> otherRange233) {
        if (otherRange233 == null) {
            return false;
        }
        return otherRange233.contains(minimum)
                || otherRange233.contains(maximum)
                || contains(otherRange233.minimum);
    }
